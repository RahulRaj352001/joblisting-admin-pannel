...
const Validation = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <div name="Validation" href="forms/validation" />
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/validation">{CustomStyles()}</div>
          </CCardBody>
        </CCard>
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/validation#browser-defaults">
              {BrowserDefaults()}
            </div>
          </CCardBody>
        </CCard>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/validation#server-side">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/validation#supported-elements">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/validation#tooltips">{Tooltips()}</div>
          </CCardBody>
        </CCard>
      </CCol>
    </CRow>
