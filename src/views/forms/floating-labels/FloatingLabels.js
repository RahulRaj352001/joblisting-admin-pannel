...
const FloatingLabels = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <div name="Floating Label" href="forms/floating-label" />
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/floating-labels">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/floating-labels#textareas">
              <CFormFloating>
                <CFormTextarea
                  id="floatingTextarea"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/floating-labels#selects">
              <CFormFloating>
                <CFormSelect
                  id="floatingSelect"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/floating-labels#layout">
              <CRow xs={{ gutter: 2 }}>
                <CCol md>
                  <CFormFloating>
                    <CFormInput
