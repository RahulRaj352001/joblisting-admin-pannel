      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/layout#form-grid">
              <CRow>
                <CCol xs>
                  <CFormInput
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/layout#horizontal-form">
              <CForm>
                <CRow className="mb-3">
                  <CFormLabel
                    htmlFor="inputEmail3"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/layout#horizontal-form-label-sizing">
              <CRow className="mb-3">
                <CFormLabel
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/layout#column-sizing">
              <CRow className="g-3">
                <CCol sm={7}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/layout#auto-sizing">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="forms/layout#inline-forms">
