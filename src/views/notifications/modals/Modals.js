...
const Modals = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <div name="Modal" href="components/modal" />
      </CCol>
      <CCol xs={12}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/modal#live-demo">{LiveDemo()}</div>
          </CCardBody>
        </CCard>
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/modal#static-backdrop">
              {StaticBackdrop()}
            </div>
          </CCardBody>
        </CCard>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/modal#scrolling-long-content">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/modal#tooltips-and-popovers">
              {TooltipsPopovers()}
            </div>
          </CCardBody>
        </CCard>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/modal#optional-sizes">{OptionalSizes()}</div>
          </CCardBody>
        </CCard>
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/modal#fullscreen-modal">
              {FullscreenModal()}
            </div>
          </CCardBody>
        </CCard>
