...
const Toasts = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <div name="Toast" href="components/toast" />
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/toast">{ExampleToast()}</div>
          </CCardBody>
        </CCard>
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/toast#translucent">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/toast#stacking">
              <CToaster>
                <CToast
                  title="CoreUI for React.js"
                  autohide={false}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/toast#custom-content">
              <CToast
                autohide={false}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/toast#color-schemes">
              <CToast
                autohide={false}
                color="primary"
