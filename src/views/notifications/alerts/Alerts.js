...
const Alerts = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <div name="Alert" href="components/alert" />
      </CCol>
      <CCol xs={12}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/alert#link-color">
              <CAlert color="primary">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/alert#additional-content">
              <CAlert color="success">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/alert#dismissing">
              <CAlert
                color="warning"
                dismissible
                onClose={() => {
