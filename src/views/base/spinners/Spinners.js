...
const Accordion = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <div name="Spinner" href="components/spinner" />
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/spinner#colors">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/spinner#growing-spinner">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/spinner#size">
              <CSpinner size="sm" />
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/spinner#buttons">
              <CButton disabled>
