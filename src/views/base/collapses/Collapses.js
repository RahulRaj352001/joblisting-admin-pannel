...
const Collapses = () => {
  ...
  return (
    <CRow>
      <CCol xs={12}>
        <div name="Collapse" href="components/collapse" />
      </CCol>
      <CCol xs={12}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/collapse#horizontal">
              <CButton
                className="mb-3"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/collapse#multiple-targets">
