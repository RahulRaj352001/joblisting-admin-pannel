...
const ListGroups = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <div name="List Group" href="components/list-group" />
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/list-group">
              <CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/list-group/#active-items">
              <CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/list-group/#disabled-items">
              <CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/list-group/#links-and-buttons">
              <CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/list-group/#contextual-classes">
              <CListGroup>
                <CListGroupItem>Dapibus ac facilisis in</CListGroupItem>
                {[
                  "primary",
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/list-group/#with-badges">
              <CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/list-group/#custom-content">
              <CListGroup>
                <CListGroupItem component="a" href="#" active>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/list-group/#checkboxes-and-radios">
              <CListGroup>
                <CListGroupItem>
