...
const ButtonGroups = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <div name="Button Group" href="components/button-group" />
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/button-group">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <div href="components/button-group#mixed-styles">
              <CButtonGroup
                role="group"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <div href="components/button-group#outlined-styles">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/button-group#checkbox-and-radio-button-groups">
              <CButtonGroup
                role="group"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/button-group#button-toolbar">
              <CButtonToolbar
                role="group"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/button-group#sizing">
              <CButtonGroup
                size="lg"
                role="group"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/button-group#nesting">
              <CButtonGroup
                role="group"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <div href="components/button-group/#vertical-variation">
              <CButtonGroup
                vertical
                role="group"
